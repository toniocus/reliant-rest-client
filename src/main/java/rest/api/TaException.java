 ...
 */
public class TaException extends RuntimeException implements OMError {
     ...
     */
    public TaException(final String pMessage) {
        super(pMessage);
    }
     ...
     */
    public TaException(final Throwable pCause) {
        super(pCause);
    }
     ...
     * @param pCause the cause
     */
    public TaException(final String pMessage, final Throwable pCause) {
    ...
    /**
     * Sets only the error code, {@link TaException#getMessage()} will be used as ErrorMessage/Description.
     *
     * @param errorCode the error code
     * @return the ta exception
     */
    public TaException withErrorCode(final String errorCode) {
     ...
     * @return the ta exception
     */
    public TaException withErrorCode(final OMErrorEnum errorCode) {
     ...
     * {@link TaException#getMessage()} is not enough or correct for reporting error
     * purposes.
     *
     * @param errorCode the error code
     ...
     * @return the ta exception
     */
    public TaException withError(final String errorCode, final String errorMessage) {
     ...
     * @return the ta exception
     */
    public TaException withErrorSource(final OMErrorSourceEnum errorSource) {
    ...
    /**
     * Gets the error message or the {@link TaException#getMessage()}
     ...
     * @return the ta exception
     */
    public TaException withFriendlyMessage(final String friendlyMsg) {
